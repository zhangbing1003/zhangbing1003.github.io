    ...
    <div class="sidebar-inner affix-top">
        ...
        ?>">
            <div class="site-author motion-element" itemprop="author" itemscope itemtype="http://schema.org/Person">
                <img class="site-author-image" src="http://blog.icejl.com/head.jpg" alt="<?php $this->options->next_name(); ?>" itemprop="image"/>
            ...
            <div class="links-of-author motion-element">
			  <span class="links-of-author-item">
			    <a href="http://www.icejl.com/" target="_blank">
			        <i class="fa fa-globe"></i> 生活家
			    </a>
			  </span>
            </div>
